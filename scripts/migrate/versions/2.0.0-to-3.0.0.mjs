/**
 * v2.0.0 → v3.0.0 — AI chat, security hardening.
 *
...
export const upgrade = {
  description:
    ...
    "totp_last_counter columns on users; share_token_hash " +
...
export const downgrade = {
  description:
    ...
    "DELETES all AI chat history and browser session ownership records.",
