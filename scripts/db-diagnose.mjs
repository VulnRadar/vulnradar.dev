 ...
 * into scripts/db-diagnose-2fa.mjs's runDiagnostics() and folds its
 ...
 * `npm run db:repair` (scripts/db-repair.mjs).
 *
 * Usage:
 *   npm run db:diagnose
 *
...
function printReport({ results, twoFactor }) {
  ...
  section("2FA data (via scripts/db-diagnose-2fa.mjs)");
  ...
  if (needsHuman > 0) {
    ...
    warningBox(`${needsHuman} finding(s) need a human decision`, [
      "These are NOT auto-fixed by scripts/db-repair.mjs -- the correct value",
