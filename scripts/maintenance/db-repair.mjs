 ...
 *
 * Same safety model as scripts/maintenance/db-repair-2fa.mjs:
    ...
    try {
      ...
      await client.query(
        ...
        [
          ...
          `Automated repair (scripts/maintenance/db-repair.mjs): ${finding.repair.description}`,
          null,
        ],
      );
...
Only touches findings scripts/maintenance/db-diagnose.mjs marked "auto-fixable" --
