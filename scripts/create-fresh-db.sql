-- VulnRadar Fresh Database Creation Script
-- This script mirrors the schema in instrumentation.ts
-- Run this to create a fresh database with all tables
-- 
-- IMPORTANT: This does NOT migrate data - use for fresh installs only
-- For migrations, the app's instrumentation.ts handles schema updates on startup
