      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto leading-relaxed text-pretty">
            ...
            This demonstrates the 100+ security checks in real-time on our own infrastructure.
          </p>
        </div>
            ...
            <CardContent className="p-8 flex flex-col items-center gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  This will scan <span className="font-mono text-xs bg-muted px-1.5 py-0.5 rounded text-foreground">{typeof window !== "undefined" ? window.location.origin : "this site"}</span> using all 100+ checks.
                </p>
              </div>
          ...
          <Card className="bg-card border-border max-w-md mx-auto">
            <CardContent className="p-8 flex flex-col items-center gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Running 100+ vulnerability checks against VulnRadar. This usually takes a few seconds.
                </p>
              </div>
        ...
        {status === "done" && result && (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10">
              ...
              <Button variant="outline" size="sm" className="bg-transparent shrink-0 gap-1" onClick={() => { setStatus("idle"); setResult(null) }}>
                Scan Again
              </Button>
            </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            {
              title: "Real Results",
              description: "These are live scan results, not pre-generated. The same 100+ checks run in real-time.",
