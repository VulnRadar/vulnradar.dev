...
export default function AdminConversationPage({ params }: PageProps) {
  ...
  return (
    // The shared shell, not a fourth hand-written copy of min-h-screen +
    // Header + a measured main + Footer. The copy that stood here is what let
    // this route's fallback and this page disagree about their own chrome.
