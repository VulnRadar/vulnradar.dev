...
export default function DisclaimerPage() {
  return (
    <article className="space-y-8">
      <LegalPageHeader title="Disclaimer" lastUpdated="March 16, 2026" type="disclaimer" />
      ...
      <LegalSection title="2. Not Professional Security Advice">
        <p>
          {APP_NAME} scan results do <strong className="text-foreground">NOT</strong> constitute
      ...
      <LegalSection title="3. Accuracy of Results">
        <p>
          ...
          information. Results may include:
        </p>
        <LegalList items={[
          <><strong>False positives</strong>: issues flagged that are not actual vulnerabilities in your context.</>,
          <><strong>False negatives</strong>: real vulnerabilities that the scanner does not detect.</>,
          <><strong>Incomplete coverage</strong>: the scanner checks specific known issues, not all vulnerability classes.</>,
        ]} />
      </LegalSection>
      ...
      <LegalSection title="5. Limitation of Liability">
        ...
        <p className="text-xs font-medium text-foreground mt-3">
          OUR TOTAL AGGREGATE LIABILITY SHALL NOT EXCEED THE GREATER OF (A) THE AMOUNTS YOU HAVE PAID 
          IN THE TWELVE (12) MONTHS PRIOR TO THE CLAIM, OR (B) $100 USD.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Legal Compliance">
        <p>Unauthorized computer scanning may violate criminal and civil laws including:</p>
        <LegalList items={[
          <><strong>United States</strong>: Computer Fraud and Abuse Act (CFAA), 18 U.S.C. § 1030</>,
          <><strong>Missouri</strong>: Missouri Computer Tampering Laws, Mo. Rev. Stat. § 569.095-569.099</>,
          <><strong>United Kingdom</strong>: Computer Misuse Act 1990</>,
          <><strong>Germany</strong>: Strafgesetzbuch (StGB) Section 202c</>,
          <><strong>European Union</strong>: Directive 2013/40/EU on attacks against information systems</>,
        ]} />
        <p className="mt-3">
          It is your responsibility to understand and comply with the laws applicable in your
          jurisdiction and the jurisdiction where the target systems are located.
        </p>
      </LegalSection>

      <LegalSection title="8. Governing Law">
        <p>
          This Disclaimer shall be governed by the laws of the State of Missouri, United States. 
          Any disputes shall be subject to the exclusive jurisdiction of the courts located in Missouri.
        </p>
      </LegalSection>
