    ...
    <article className="space-y-8">
      ...
      <LegalSection title="5. Data Retention">
        <LegalList
          items={[
            <>
              <strong>Scan history:</strong> 90 days, then automatically
              deleted.
            </>,
            <>
            ...
            <>
              <strong>Expired sessions:</strong> Deleted on every server
              restart.
            </>,
            <>
      ...
      <LegalSection title="7. Cookies">
        <p>
          We use a single HTTP-only session cookie (
          <code className="text-xs bg-muted px-1.5 py-0.5 rounded">
            vulnradar_session
          </code>
          ) to maintain your login state. We do not use advertising cookies,
