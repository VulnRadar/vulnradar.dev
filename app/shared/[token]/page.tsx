              ...
              <>
                ...
                <div className="relative overflow-hidden rounded-xl border border-border bg-card">
                  ...
                  <div className={cn(
                    ...
                    hasCritical ? "bg-gradient-to-r from-red-500 to-red-600" :
                    hasHigh ? "bg-gradient-to-r from-orange-500 to-amber-500" :
                    issueCount > 0 ? "bg-gradient-to-r from-yellow-500 to-amber-400" :
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    {scannedBy && (
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        {scannedByRole && scannedByRole !== STAFF_ROLES.USER && ROLE_BADGE_STYLES[scannedByRole] && (
                          <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider border ${ROLE_BADGE_STYLES[scannedByRole]}`}>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm">
                      <div className="flex items-center gap-1.5 text-muted-foreground">
                        ...
                        <span>{formatRelativeTime(new Date(result.scannedAt))}</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-muted-foreground">
                      ...
                      <div className={cn(
                        ...
                        issueCount === 0 ? "text-emerald-500" : hasCritical ? "text-red-500" : hasHigh ? "text-orange-500" : "text-yellow-500"
                      )}>
                        {issueCount === 0 ? (
                        ...
                        <span>{issueCount === 0 ? "No issues" : `${issueCount} issue${issueCount !== 1 ? "s" : ""}`}</span>
                      </div>
                ...
                {scanNotes && (
                  <div className="rounded-xl border border-border bg-card p-5">
                    ...
                    <p className="text-sm text-muted-foreground whitespace-pre-wrap leading-relaxed">{scanNotes}</p>
                  </div>
                )}
