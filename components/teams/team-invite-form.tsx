      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:items-end">
        <div className="flex-1 min-w-0 flex flex-col gap-1.5">
          ...
          <Input
            ...
            // The panel appears on click, so focus follows it here instead
            // of staying on the Invite button that opened it.
            autoFocus
            value={inviteEmail}
      ...
      {inviteToken && (
        <div className="mt-4 p-4 rounded-lg bg-muted/50 border border-border/50">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 text-xs bg-background border border-border rounded-md px-3 py-2 font-mono break-all select-all min-w-0">
              {inviteUrl}
            </code>
            <Button
              variant="outline"
