...
export function TeamInviteForm({
  inviteEmail, inviteRole, inviting, inviteToken, copied,
  onEmailChange, onRoleChange, onInvite, onCopy, onClose,
}: TeamInviteFormProps) {
    ...
    <Card className="bg-card border-border/50">
      <CardContent className="p-5">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button onClick={onInvite} disabled={inviting || !inviteEmail.trim()} className="h-10 shrink-0">
        ...
        {inviteToken && (
          <div className="mt-4 p-4 rounded-lg bg-muted/50 border border-border/50">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" className="shrink-0 h-9 w-9 p-0" onClick={onCopy}>
                {copied
