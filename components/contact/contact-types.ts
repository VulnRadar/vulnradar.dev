...
export const CATEGORIES: ContactCategory[] = [
  { id: "bug", label: "Bug Report", icon: Bug, desc: "Something is broken or not working" },
  { id: "feature", label: "Feature Request", icon: Lightbulb, desc: "Suggest a new feature or improvement" },
  { id: "security", label: "Security Issue", icon: Shield, desc: "Report a vulnerability responsibly" },
  { id: "help", label: "General Help", icon: HelpCircle, desc: "Need help using VulnRadar" },
  { id: "billing", label: "Billing Issue", icon: CreditCard, desc: "Payment or subscription help" },
  { id: "enterprise", label: "Enterprise", icon: Building2, desc: "Team plans & partnerships" },
  { id: "staff_application", label: "Apply for Staff", icon: Users, desc: "Join the VulnRadar team" },
  { id: "feedback", label: "Feedback", icon: MessageSquare, desc: "Share your thoughts with us" },
]
