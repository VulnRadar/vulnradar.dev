...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className={cn("relative vr-auth-only", isPublicRoute && "!invisible !pointer-events-none")}>
      ...
      {open && (
        <div className="fixed right-3 left-3 sm:left-auto sm:absolute sm:right-0 sm:w-80 top-14 sm:top-full sm:mt-2 rounded-xl border border-border bg-card shadow-xl z-[100] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
          {/* Header */}
