...
export function OAuthButtons({ actionLabel }: OAuthButtonsProps) {
  ...
  const anyConfigured = providers.google || providers.github || providers.discord;
    ...
    <>
      ...
      {providers.google && (
        <Button
          ...
          onClick={() => (window.location.href = API.AUTH.OAUTH_START("google"))}
        >
      ...
      {providers.github && (
        <Button
          ...
          size="lg"
          className={cn("h-11 w-full border-border/60 gap-2", authFocusRing)}
          onClick={() => (window.location.href = API.AUTH.OAUTH_START("github"))}
        >
      ...
      {providers.discord && (
        <Button
          ...
          size="lg"
          className={cn("h-11 w-full border-border/60 gap-2", authFocusRing)}
          onClick={() => (window.location.href = API.AUTH.OAUTH_START("discord"))}
        >
          <DiscordIcon />
