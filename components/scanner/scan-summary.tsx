...
export function ScanSummary({ result }: ScanSummaryProps) {
  ...
  const safetyConfig = {
    safe: {
      ...
      description: "No exploitable vulnerabilities detected. Any findings are hardening recommendations.",
      icon: ShieldCheck,
    ...
    caution: {
      ...
      description: "Potential security concerns detected. Review findings before entering sensitive information.",
      icon: ShieldAlert,
    ...
    unsafe: {
      ...
      description: "Actively exploitable vulnerabilities found. Avoid entering personal information.",
      icon: ShieldX,
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 p-4">
          ...
          <div className={cn(
            ...
            <div className={cn("flex items-center justify-center w-12 h-12 rounded-xl shrink-0", config.pillBg)}>
      ...
      <div className="grid grid-cols-5 gap-2">
        {severityCards.map(({ key, label, icon: Icon, color, bg, border, barColor }) => {
          ...
          return (
            ...
            >
              ...
              <Icon className={cn("h-4 w-4", hasCount ? color : "text-muted-foreground/50")} />
              <span className={cn(
