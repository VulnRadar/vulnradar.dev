// lucide-react dropped brand/logo icons, so the mark is an inline SVG. It
// lives here rather than inside app/repos/page.tsx because the list moved out
// into its own component and both still need it.
