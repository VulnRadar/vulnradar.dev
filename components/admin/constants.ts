...
export const ADMIN_TABS = [
  { key: "users" as const, label: "Users", description: "Manage user accounts" },
  { key: "teams" as const, label: "Teams", description: "View and manage teams" },
  { key: "notifications" as const, label: "Notifications", description: "Site-wide announcements" },
  { key: "admins" as const, label: "Staff", description: "Active staff members" },
  { key: "audit" as const, label: "Audit Log", description: "Track admin actions" },
]

// Audit filter categories
