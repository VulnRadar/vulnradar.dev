            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={cn("p-2 rounded-lg", variantStyle.bg)}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Button variant="ghost" size="icon" onClick={() => openEditDialog(notif)}>
      ...
      <Dialog open={isCreating} onOpenChange={(open) => !open && closeDialog()}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid gap-4 py-4">
            ...
            {/* Path Pattern */}
            <div className="grid gap-2">
              <Label htmlFor="path_pattern">Path Pattern (optional)</Label>
              <Input
                id="path_pattern"
            ...
            {formData.is_dismissible && (
              <div className="grid gap-2">
                <Label htmlFor="dismiss_duration_hours">Re-show after dismiss (hours, empty = permanent)</Label>
                <Input
            ...
            <div className="grid gap-2">
              ...
              {formData.action_url && (
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="action_external">Open in new tab</Label>
                </div>
              )}
            </div>
          </div>
