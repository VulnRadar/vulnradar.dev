...
import type { AdminBadgesResponse, AdminActionResponse } from "../types.responses"
 ...
 */
export async function awardBadge(userId: number, badgeId: number): Promise<AdminActionResponse> {
 ...
 */
export async function revokeBadge(userId: number, badgeId: number): Promise<AdminActionResponse> {
 ...
 * Delete a badge
 */
export async function deleteBadge(badgeId: number): Promise<AdminActionResponse> {
