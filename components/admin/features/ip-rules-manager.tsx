...
import { Plus, Trash2, RefreshCw, Globe, Network, Loader2, AlertTriangle, CheckCircle2, Eye } from "lucide-react"
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Whitelist and blacklist rules for IPs and URLs</p>
                </div>
              </div>
