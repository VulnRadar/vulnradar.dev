...
const STEPS = [
  ...
  },
  {
    ...
    description: "Enter any URL on the Scanner page to run 65+ security checks instantly. You'll get a detailed report with severity ratings, explanations, and fix recommendations.",
