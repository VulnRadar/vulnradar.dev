...
export const backdrops = {
  ...
  header: "bg-background/95 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60",
...
export const effects = {
  ...
  // Gradient text
  gradientText: "bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70",
